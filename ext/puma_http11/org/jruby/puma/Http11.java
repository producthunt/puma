...
public class Http11 extends RubyObject {
    ...
    public final static int MAX_REQUEST_PATH_LENGTH = 1024 * 10;
    public final static String MAX_REQUEST_PATH_LENGTH_ERR = "HTTP element REQUEST_PATH is longer than the 10240 allowed length.";
